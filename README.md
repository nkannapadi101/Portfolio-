...
|---|---|---|
| [World Bank Urban Heat Management](#project-1-cmu-capstone-consulting-project-with-the-world-bank-group) | Climate & urban planning | GIS, raster analysis, suitability ranking |
| [Determining Factors for Delaying Medical Treatment](#project-2-determining-factors-for-delaying-medical-treatment) | Health policy | Logistic regression, R, reproducible reporting |
| [Mapping Affordable Housing Potential in Pittsburgh](#project-3-mapping-affordable-housing-potential-in-pittsburgh) | Housing & economic development | GIS, kernel density, spatial overlay |
